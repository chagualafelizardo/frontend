...
//     print('[DEBUG] Attempting to save rental history...');
//     print('[DEBUG] Data to be saved:');
//     print('- Date: ${_dataValor?.toIso8601String()}');
//     print('- Amount: $_valor');
//     print('- Vehicle ID: $_veiculoID');
//     print('- Notes: $_obs');

//     try {
//       print('[DEBUG] Calling service.create()...');
//       await widget.service.create(newHistory);
      
//       print('[DEBUG] Rental history saved successfully');
...
//       print('[DEBUG] Switching to history tab...');
//       _tabController.animateTo(0);
      
//     } catch (e, stackTrace) {
//       print('[ERROR] Failed to save rental history:');
...
//         print('[ERROR DETAIL] Format exception occurred');
//       } else if (e is TimeoutException) {
//         print('[ERROR DETAIL] Request timed out');
//       } else if (e is http.ClientException) {
//         print('[ERROR DETAIL] HTTP client exception');
//       }
      
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text('Error saving rental history: ${e.toString()}')));
//     } finally {
//       print('[DEBUG] Submit form operation completed');
//     }
//   } else {
